...
namespace Sudoku
{
    class Creator
    {
        public int[,] Get()
        {
            ...
            /*            lines.Add("-------------------------");
                        lines.Add("| 0 0 4 | 0 0 6 | 0 0 9 |");
                        lines.Add("| 0 8 0 | 0 1 0 | 0 0 0 |");
                        lines.Add("| 0 0 3 | 0 2 0 | 4 5 0 |");
                        lines.Add("-------------------------");
                        lines.Add("| 0 0 0 | 0 0 0 | 0 0 2 |");
                        lines.Add("| 0 5 6 | 0 0 0 | 7 8 0 |");
                        lines.Add("| 1 0 0 | 0 0 0 | 0 0 0 |");
                        lines.Add("-------------------------");
                        lines.Add("| 0 2 5 | 0 3 0 | 1 0 0 |");
                        lines.Add("| 0 0 0 | 0 4 0 | 0 6 0 |");
                        lines.Add("| 9 0 0 | 5 0 0 | 3 0 7 |");
                        lines.Add("-------------------------");*/

            lines.Add("-------------------------");
            lines.Add("| 1 0 0 | 2 0 0 | 3 0 0 |");
            lines.Add("| 2 0 0 | 3 0 0 | 1 0 0 |");
            lines.Add("| 3 0 0 | 1 0 0 | 2 0 0 |");
            lines.Add("-------------------------");
            lines.Add("| 0 4 7 | 0 5 8 | 0 6 9 |");
            lines.Add("| 0 5 8 | 0 6 9 | 0 4 7 |");
            lines.Add("| 0 6 9 | 0 4 7 | 0 5 8 |");
            lines.Add("-------------------------");
            lines.Add("| 0 7 4 | 0 8 5 | 0 9 6 |");
            lines.Add("| 0 8 5 | 0 9 6 | 0 7 4 |");
            lines.Add("| 0 9 6 | 0 7 4 | 0 8 5 |");
            lines.Add("-------------------------");
